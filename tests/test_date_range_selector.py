...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            datetime(2020, 1, 1),
            datetime(2022, 12, 31),
            (datetime(2021, 1, 15), datetime(2021, 1, 25)),
            d(2020, 1, 1),
            d(2022, 12, 31),
            (d(2021, 1, 15), d(2021, 1, 25)),
        ),
        ...
        (
            "20210101",
            "20221231",
            ("20210615", "invalid_date"),
            d(2021, 1, 1),
            d(2022, 12, 31),
            (d(2021, 6, 15), d(2022, 12, 31)),
        ),
    ],
)
@pytest.mark.parametrize(
...
def test_date_range_selector_initialization(
    start_input,
    end_input,
    value_input,
    expected_start,
...
def test_date_range_selector_shortcuts(
    shortcut_name, expected_start_offset_days, expected_start_offset_months, expected_start_offset_years
):
