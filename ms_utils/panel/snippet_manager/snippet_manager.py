...
class SnippetManager:
    ...
    def panel_display(self):
        ...
        self._tag_select = pn.widgets.MultiChoice(options=list(self._tag_list), value=[], width=300, name="Tags")
        ...
        layout = pn.Column(
            ...
            pn.Row(
                ...
                pn.Column(self._search_input, self._file_path, pn.Row(self._save_btn, self._reload_btn), self._editor),
            ),
        )
        return layout
